...
gem 'active_model_serializers', '~> 0.10', '>= 0.10.11'
gem 'addressable', '~> 2.6'
...
gem 'sidekiq-unique-jobs', '~> 6.0', '>= 6.0.23'
...
group :development do
  ...
  gem 'bundler-audit', '~> 0.7', '>= 0.7.0', require: false
