...
gem 'pghero', '~> 2.7', '>= 2.7.0'
gem 'dotenv-rails', '~> 2.7', '>= 2.7.5'

gem 'aws-sdk-s3', '~> 1.46', '>= 1.46.0', require: false
gem 'fog-core', '~> 2.1'
gem 'fog-openstack', '~> 0.3', '>= 0.3.7', require: false
gem 'paperclip', '~> 6.0', '>= 6.0.0'
gem 'paperclip-av-transcoder', '~> 0.6', '>= 0.6.4'
gem 'streamio-ffmpeg', '~> 3.0'
gem 'blurhash', '~> 0.1'

gem 'active_model_serializers', '~> 0.10', '>= 0.10.10'
...
gem 'premailer-rails'
gem 'rack-attack', '~> 6.1', '>= 6.1.0'
gem 'rack-cors', '~> 1.0', '>= 1.0.5', require: 'rack/cors'
...
gem 'sidekiq-unique-jobs', '~> 6.0', '>= 6.0.13'
gem 'sidekiq-bulk', '~> 0.2.0'
gem 'simple-navigation', '~> 4.1', '>= 4.1.0'
...
gem 'json-ld-preloaded', '~> 3.0', '>= 3.0.3'
gem 'rdf-normalize', '~> 0.3'

group :development, :test do
  gem 'fabrication', '~> 2.20'
  gem 'fuubar', '~> 2.4'
  gem 'i18n-tasks', '~> 0.9', '>= 0.9.29', require: false
  gem 'pry-byebug', '~> 3.7'
  gem 'pry-rails', '~> 0.3'
...
group :test do
  ...
  gem 'faker', '~> 2.1'
  gem 'microformats', '~> 4.1', '>= 4.1.0'
  gem 'rails-controller-testing', '~> 1.0', '>= 1.0.4'
  gem 'rspec-sidekiq', '~> 3.0', '>= 3.0.3'
  gem 'simplecov', '~> 0.17', '>= 0.17.0', require: false
